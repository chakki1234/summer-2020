...
\hhline{|-|-|-|-|-}
	...
	{\gnumericPB{\raggedright}\gnumbox[l]{\textbf{X}}}
	...
	{\gnumericPB{\raggedleft}\gnumbox[r]{\textbf{3}}}
\\
\hhline{|-----|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{\textbf{P(X)}}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\frac{125}{216}$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\frac{75}{216}$}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\frac{15}{216}$}}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\frac{1}{216}$}}
\\
\hhline{|-|-|-|-|-|}
\end{tabular}
