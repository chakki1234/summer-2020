...
# equation - 2x+5
X_coord3 = np.array(np.linspace(-5.0, 5.0, num=40))
Y_coord3 =  [2*num + 5 for num in X_coord3]

# equation - 3x-2
X_coord4 = np.array(np.linspace(-1.0, 5.0, num=40))
...
plt.legend(loc='best')
plt.grid()
# plt.savefig('./figs/eq5.eps')

# if using termux
# plt.savefig('./figs/eq.pdf')
